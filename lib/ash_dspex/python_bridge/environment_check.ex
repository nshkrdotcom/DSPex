defmodule AshDSPex.PythonBridge.EnvironmentCheck do
  @moduledoc """
  ...
  ## Usage
      ...
      case AshDSPex.PythonBridge.EnvironmentCheck.validate_environment() do
        {:ok, environment_info} ->
  ...
  ## Examples
      ...
      iex> AshDSPex.PythonBridge.EnvironmentCheck.validate_environment()
      {:ok, %{
  ...
  ## Examples
      ...
      iex> AshDSPex.PythonBridge.EnvironmentCheck.validate_python_executable()
      {:ok, "/usr/bin/python3"}
  ...
  ## Examples
      ...
      iex> AshDSPex.PythonBridge.EnvironmentCheck.check_dspy_availability()
      {:ok, "2.4.9"}
  ...
  ## Examples
      ...
      iex> AshDSPex.PythonBridge.EnvironmentCheck.validate_bridge_script()
  ...
  defp get_configuration do
    bridge_config = Application.get_env(:ash_dspex, :python_bridge, %{})
  ...
  defp validate_bridge_script(script_relative_path) do
    script_path = Path.join(:code.priv_dir(:ash_dspex), script_relative_path)
