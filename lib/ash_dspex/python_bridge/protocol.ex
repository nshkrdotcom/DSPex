defmodule AshDSPex.PythonBridge.Protocol do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> AshDSPex.PythonBridge.Protocol.encode_request(1, :ping, %{})
      ~s({"id":1,"command":"ping","args":{},"timestamp":"2024-01-01T00:00:00Z"})

      iex> AshDSPex.PythonBridge.Protocol.encode_request(2, "create_program", %{signature: %{}})
  ...
  ## Examples
      ...
      iex> AshDSPex.PythonBridge.Protocol.decode_response(json)
      {:ok, 1, %{"status" => "ok"}}
      ...
      iex> AshDSPex.PythonBridge.Protocol.decode_response("invalid json")
      {:error, :decode_error}
  """
  ...
  ## Examples
      ...
      iex> AshDSPex.PythonBridge.Protocol.validate_request(request)
      :ok

      iex> AshDSPex.PythonBridge.Protocol.validate_request(%{"id" => 1})
  ...
  ## Examples
      ...
      iex> AshDSPex.PythonBridge.Protocol.validate_response(response)
      :ok
      ...
      iex> AshDSPex.PythonBridge.Protocol.validate_response(%{"id" => 1})
  ...
  ## Examples
      ...
      iex> AshDSPex.PythonBridge.Protocol.create_error_response(1, "Command failed")
  ...
  ## Examples
      ...
      iex> AshDSPex.PythonBridge.Protocol.create_success_response(1, %{"status" => "ok"})
  ...
  ## Examples
      ...
      iex> AshDSPex.PythonBridge.Protocol.extract_request_id(%{"id" => 42})
      42

      iex> AshDSPex.PythonBridge.Protocol.extract_request_id(%{"command" => "ping"})
      nil
  """
