defmodule AshDSPex.PythonBridge.ConditionalSupervisor do
  @moduledoc """
  ...
  defp should_start_bridge?(opts) do
    ...
    if Mix.env() == :test do
      ...
      case Keyword.get(
             opts,
             :enabled,
             Application.get_env(:ash_dspex, :python_bridge_enabled, :auto)
           ) do
        false ->
          false
  ...
  defp get_test_mode do
    case System.get_env("TEST_MODE") do
      nil ->
        Application.get_env(:ash_dspex, :test_mode, :full_integration)
