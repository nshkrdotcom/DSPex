defmodule AshDSPex.PythonBridge.Bridge do
  @moduledoc """
  ...
  ## Usage
      ...
      # Start the bridge
      {:ok, _pid} = AshDSPex.PythonBridge.Bridge.start_link()

      # Make a call
      {:ok, result} = AshDSPex.PythonBridge.Bridge.call(:ping, %{})

      # Create a DSPy program
      {:ok, program_info} = AshDSPex.PythonBridge.Bridge.call(:create_program, %{
        id: "qa_program",
        signature: %{
  ...
  alias AshDSPex.PythonBridge.{Protocol, EnvironmentCheck}
  ...
  ## Examples
      ...
      {:ok, pid} = AshDSPex.PythonBridge.Bridge.start_link()
      {:ok, pid} = AshDSPex.PythonBridge.Bridge.start_link(name: MyBridge)
  """
  ...
  ## Examples
      ...
      {:ok, result} = AshDSPex.PythonBridge.Bridge.call(:ping, %{})
      {:ok, stats} = AshDSPex.PythonBridge.Bridge.call(:get_stats, %{}, 5000)
      {:error, reason} = AshDSPex.PythonBridge.Bridge.call(:unknown_command, %{})
  """
  ...
  ## Examples
      ...
      :ok = AshDSPex.PythonBridge.Bridge.cast(:cleanup, %{})
  """
  ...
  ## Examples
      ...
      :ok = AshDSPex.PythonBridge.Bridge.stop()
  """
  @spec stop() :: :ok
  def stop do
  ...
  defp build_config(opts) do
    app_config = Application.get_env(:ash_dspex, :python_bridge, %{})
