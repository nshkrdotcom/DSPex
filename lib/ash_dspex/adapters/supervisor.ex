defmodule AshDSPex.Adapters.Supervisor do
  @moduledoc """
  ...
  alias AshDSPex.Adapters.Registry
  ...
  - `:name` - Supervisor name (default: AshDSPex.Adapters.Supervisor)
  ...
  defp build_children(opts) do
    ...
    base_children = [
      ...
      {Registry, keys: :unique, name: AshDSPex.Adapters.ProcessRegistry}
    ]
  ...
  defp determine_production_adapters do
    ...
    configured = Application.get_env(:ash_dspex, :enabled_adapters, [:python_port])
