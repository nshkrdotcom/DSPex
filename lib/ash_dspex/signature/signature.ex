defmodule AshDSPex.Signature do
  @moduledoc """
  ...
  When `use AshDSPex.Signature` is called, this macro:
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      @before_compile AshDSPex.Signature.Compiler
    end
  end
