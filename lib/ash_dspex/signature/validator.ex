defmodule AshDSPex.Signature.Validator do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> AshDSPex.Signature.Validator.validate_fields(data, fields)
      {:ok, %{name: "Alice", age: 30}}

      iex> fields = [{:name, :string, []}, {:age, :integer, []}]
      iex> bad_data = %{name: "Alice"}  # missing age
      iex> AshDSPex.Signature.Validator.validate_fields(bad_data, fields)
  ...
  ## Examples
      ...
      iex> AshDSPex.Signature.Validator.validate_type("hello", :string)
      {:ok, "hello"}

      iex> AshDSPex.Signature.Validator.validate_type(42, :string)
      {:error, "Expected :string, got: 42 (integer)"}

      iex> AshDSPex.Signature.Validator.validate_type([1, 2, 3], {:list, :integer})
      {:ok, [1, 2, 3]}
  """
  ...
  ## Examples
      ...
      iex> fields = [{:name, :string, []}, {:age, :integer, []}]
      iex> data = %{name: "Alice", age: 30}
      iex> AshDSPex.Signature.Validator.check_required_fields(data, fields)
      :ok

      iex> fields = [{:name, :string, []}, {:age, :integer, []}]
      iex> incomplete_data = %{name: "Alice"}
      iex> AshDSPex.Signature.Validator.check_required_fields(incomplete_data, fields)
      {:error, ["Missing required field: age"]}
  """
  ...
  ## Examples
      ...
      iex> AshDSPex.Signature.Validator.validate_partial(partial_data, fields)
      {:ok, %{name: "Alice"}}
  """
