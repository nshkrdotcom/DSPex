...
defmodule Dspy do
  ...
  @spec configure_cache(term(), term(), term(), term(), integer(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  @spec configure_cache(term(), term(), term(), term(), integer(), boolean()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  @spec configure_cache(term(), term(), term(), term(), integer(), boolean(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  @spec configure_cache(term(), term(), term(), term(), integer(), boolean(), term()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  @spec configure_cache(term(), term(), term(), term(), integer(), boolean(), term(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  ...
  @spec inspect_history(integer(), term()) :: {:ok, nil} | {:error, Snakepit.Error.t()}
  @spec inspect_history(integer(), term(), keyword()) :: {:ok, nil} | {:error, Snakepit.Error.t()}
  ...
  - `normalize` (term() default: <function default_normalize at 0x79fef1dcdee0>)
