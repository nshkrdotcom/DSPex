...
defmodule Dspy.Signatures.Signature do
  @moduledoc """
  Wrapper for Python class Signature.
  """
  ...
  @doc """
  Python method `Signature.schema_json`.
  ...
  @doc """
  Python method `Signature.parse_file`.
  ...
  @doc """
  Python method `Signature.schema`.
  ...
  @doc """
  Python method `Signature.dump_state`.
  ...
  @doc """
  Python method `Signature._calculate_keys`.
  ...
  @doc """
  Python method `Signature.construct`.
  ...
  @doc """
  Python method `Signature.update_forward_refs`.
  ...
  @doc """
  Python method `Signature._copy_and_set_values`.
  ...
  @doc """
  Python method `Signature.load_state`.
  ...
  @doc """
  Python method `Signature._get_value`.
  ...
  @doc """
  Python method `Signature.parse_obj`.
  ...
  - `instructions` - Instruction text to append to the existing instructions. (type: `String.t()`)
  ...
  - `term()`
  """
  @spec append_instructions(SnakeBridge.Ref.t(), String.t(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def append_instructions(ref, instructions, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :append_instructions, [instructions], opts)
  end
  ...
  @doc """
  Python method `Signature.from_orm`.
  ...
  @doc """
  Python method `Signature.parse_raw`.
  ...
  @doc """
  Python method `Signature.validate`.
