...
defmodule Dspy.BetterTogether do
  ...
  - `effective_max_errors` (integer() | nil)
  - `provide_traceback` (boolean() | nil)
  ...
  - `optimizer_compile_args` (%{optional(String.t()) => %{optional(String.t()) => term()}} | nil)
  - `teacher` (list(term()) | nil)

  ## Returns

  - `%{optional(String.t()) => %{optional(String.t()) => term()}}`
  """
  @spec _prepare_optimizer_compile_args(
          SnakeBridge.Ref.t(),
          %{optional(String.t()) => %{optional(String.t()) => term()}} | nil,
          list(term()) | nil,
          keyword()
        ) ::
  ...
  - `student` (term())
  - `teacher` ((term() | list(term())) | nil)

  ## Returns

  - `{term(), list(term()) | nil}`
  """
  @spec _prepare_student_and_teacher(
          SnakeBridge.Ref.t(),
          term(),
          (term() | list(term())) | nil,
          keyword()
        ) :: {:ok, {term(), list(term()) | nil}} | {:error, Snakepit.Error.t()}
  ...
  @spec _prepare_trainset_and_valset(
          ...
          float(),
          keyword()
        ) :: {:ok, {list(term()), list(term()) | nil}} | {:error, Snakepit.Error.t()}
  ...
  @spec _run_and_evaluate_step(
          ...
          boolean() | nil,
          keyword()
        ) :: {:ok, {term(), float() | nil, boolean(), boolean()}} | {:error, Snakepit.Error.t()}
