...
defmodule Dspy.RLM do
  ...
  def _interpreter_context(ref, execution_tools, factory, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_interpreter_context, [execution_tools, factory], opts)
  end
  ...
  - `term()`
  """
  @spec _make_interpreter_tool(SnakeBridge.Ref.t(), term(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def _make_interpreter_tool(ref, tool, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_make_interpreter_tool, [tool], opts)
  end
  ...
  - `term() | Dspy.Primitives.ReplTypes.REPLHistory.t()`
  """
  @spec _process_execution_result(
          ...
          {:ok, term() | Dspy.Primitives.ReplTypes.REPLHistory.t()} | {:error, Snakepit.Error.t()}
  ...
  - `interpreter_factory` - Optional zero-argument factory, passed by keyword. Overrides the constructor and configured factories for this invocation. Must return a fresh interpreter; RLM injects tools and output metadata and shuts it down on exit, including failures. **input_args: Input values matching the signature's input fields.
  ...
  @doc """
  Python method `RLM._get_execution_instructions`.
  ...
  - `String.t()`
  """
  @spec _get_execution_instructions(SnakeBridge.Ref.t(), term(), keyword()) ::
          {:ok, String.t()} | {:error, Snakepit.Error.t()}
  def _get_execution_instructions(ref, factory, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_get_execution_instructions, [factory], opts)
  end
  ...
  def _execute_iteration(
    ...
    SnakeBridge.Runtime.call_method(
      ref,
      :_execute_iteration,
      [repl, variables, history, iteration, input_args, output_field_names, interpreter_factory],
      opts
    )
  end
  ...
  - `{%{optional(String.t()) => term()} | nil, String.t() | nil}`
  """
  @spec _process_final_output(SnakeBridge.Ref.t(), term(), list(String.t()), keyword()) ::
          {:ok, {%{optional(String.t()) => term()} | nil, String.t() | nil}}
          | {:error, Snakepit.Error.t()}
  ...
  - `%{optional(String.t()) => term()}`
  """
  @spec _normalize_tools(SnakeBridge.Ref.t(), list(term()) | nil, keyword()) ::
          {:ok, %{optional(String.t()) => term()}} | {:error, Snakepit.Error.t()}
  ...
  - `nil`
  """
  @spec _validate_namespace(SnakeBridge.Ref.t(), %{optional(String.t()) => term()}, keyword()) ::
          {:ok, nil} | {:error, Snakepit.Error.t()}
  def _validate_namespace(ref, tools, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_validate_namespace, [tools], opts)
  end

  @doc """
  Python method `RLM._format_interpreter_rules`.

  ## Parameters

  - `execution_instructions` (String.t())

  ## Returns

  - `String.t()`
  """
  @spec _format_interpreter_rules(SnakeBridge.Ref.t(), String.t(), keyword()) ::
          {:ok, String.t()} | {:error, Snakepit.Error.t()}
  def _format_interpreter_rules(ref, execution_instructions, opts \\ []) do
    SnakeBridge.Runtime.call_method(
      ref,
      :_format_interpreter_rules,
  ...
  - `%{optional(String.t()) => term()}`
  """
  @spec _prepare_serializable_vars(
          SnakeBridge.Ref.t(),
          %{optional(String.t()) => term()},
          term(),
          keyword()
        ) :: {:ok, %{optional(String.t()) => term()}} | {:error, Snakepit.Error.t()}
  def _prepare_serializable_vars(ref, input_args, repl, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_prepare_serializable_vars, [input_args, repl], opts)
  end
  ...
  - `term()`
  """
  @spec _action_signature_for_current_factory(SnakeBridge.Ref.t(), term(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def _action_signature_for_current_factory(ref, factory, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_action_signature_for_current_factory, [factory], opts)
  end

  @spec _reserved_result_names(SnakeBridge.Ref.t()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def _reserved_result_names(ref) do
    SnakeBridge.Runtime.get_attr(ref, :_RESERVED_RESULT_NAMES)
  end

  @spec _reserved_sandbox_names(SnakeBridge.Ref.t()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def _reserved_sandbox_names(ref) do
    SnakeBridge.Runtime.get_attr(ref, :_RESERVED_SANDBOX_NAMES)
  end
