...
defmodule Dspy.Propose.GroundedProposer.DescribeProgram do
  ...
  @doc """
  Python method `DescribeProgram.parse_raw`.
  ...
  @doc """
  Python method `DescribeProgram.parse_obj`.
  ...
  @doc """
  Python method `DescribeProgram._get_value`.
  ...
  @doc """
  Python method `DescribeProgram.dict`.
  ...
  @doc """
  Python method `DescribeProgram._calculate_keys`.
  ...
  @doc """
  Python method `DescribeProgram.dump_state`.
  ...
  @doc """
  Python method `DescribeProgram.schema_json`.
  ...
  @doc """
  Python method `DescribeProgram._iter`.
  ...
  @doc """
  Python method `DescribeProgram.load_state`.
  ...
  @doc """
  Python method `DescribeProgram.construct`.
  ...
  @doc """
  Python method `DescribeProgram.from_orm`.
  ...
  @doc """
  Python method `DescribeProgram._copy_and_set_values`.
  ...
  @doc """
  Python method `DescribeProgram.json`.
  ...
  @doc """
  Python method `DescribeProgram.validate`.
  ...
  @doc """
  Python method `DescribeProgram.schema`.
  ...
  @doc """
  Python method `DescribeProgram.update_forward_refs`.
  ...
  @doc """
  Python method `DescribeProgram.parse_file`.
