...
# Python class: LocalProvider

defmodule Dspy.Clients.LmLocal.LocalProvider do
  @moduledoc """
  Wrapper for Python class LocalProvider.
  """
  ...
  @doc """
  Python method `LocalProvider.finetune`.
  ...
  @doc """
  Python method `LocalProvider.is_provider_model`.
  ...
  @doc """
  Python method `LocalProvider.kill`.
  ...
  @doc """
  Python method `LocalProvider.launch`.
