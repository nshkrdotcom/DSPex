...
# Python class: TrainingJobDatabricks

defmodule Dspy.Clients.Databricks.TrainingJobDatabricks do
  @moduledoc """
  ...
  @doc """
  Python method `TrainingJobDatabricks._Future__get_result`.
  ...
  @doc """
  Python method `TrainingJobDatabricks._invoke_callbacks`.
  ...
  @doc """
  Python method `TrainingJobDatabricks.status`.
