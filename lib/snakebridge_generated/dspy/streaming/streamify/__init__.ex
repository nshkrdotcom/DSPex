...
defmodule Dspy.Streaming.Streamify do
  ...
  All functions accept a `__runtime__` option for controlling execution behavior:
      ...
      Dspy.Streaming.Streamify.some_function(args, __runtime__: [timeout: 120_000])
  ...
  ### Example with timeout override
      ...
      Dspy.Streaming.Streamify.predict(data, __runtime__: [timeout_profile: :ml_inference])

      # Or explicit timeout
      Dspy.Streaming.Streamify.predict(data, __runtime__: [timeout: 600_000])

      # Route to a pool and enforce strict affinity
      Dspy.Streaming.Streamify.predict(data, __runtime__: [pool_name: :strict_pool, affinity: :strict_queue])
