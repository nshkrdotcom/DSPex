...
defmodule Dspy.CodeAct do
  ...
  - `interpreter_factory` - Zero-argument callable that creates an interpreter for each forward pass. The callable may be invoked concurrently, and DSPy shuts down each interpreter it returns. Defaults to `dspy.PythonInterpreter`. `dspy.configure(interpreter_factory=...)` replaces this default.
  ...
  ## Examples
      ...
      ```
  """
  @spec new(String.t() | term(), list(term()), list(term()), keyword()) ::
