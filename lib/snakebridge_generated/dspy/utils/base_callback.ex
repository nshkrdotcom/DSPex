...
defmodule Dspy.Utils.BaseCallback do
  ...
  - `term()`
  """
  @spec on_compile_end(SnakeBridge.Ref.t(), String.t(), term() | nil, list(term()), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def on_compile_end(ref, call_id, outputs, args, opts \\ []) do
    {args, opts} = SnakeBridge.Runtime.normalize_args_opts(args, opts)
  ...
  def on_compile_start(ref, call_id, instance, inputs, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :on_compile_start, [call_id, instance, inputs], opts)
  end
  ...
  - `term()`
  """
  @spec on_evaluate_end(SnakeBridge.Ref.t(), String.t(), term() | nil, list(term()), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  ...
  @doc """
  Python method `BaseCallback.on_interpreter_execute_end`.

  ## Parameters

  - `call_id` (String.t())
  - `outputs` (term() | nil)
  - `exception` (term() | nil default: None)

  ## Returns

  - `term()`
  """
  @spec on_interpreter_execute_end(
          SnakeBridge.Ref.t(),
          String.t(),
          term() | nil,
          list(term()),
  ...
  def on_interpreter_execute_end(ref, call_id, outputs, args, opts \\ []) do
    {args, opts} = SnakeBridge.Runtime.normalize_args_opts(args, opts)
  ...
  @doc """
  Python method `BaseCallback.on_interpreter_execute_start`.
  ...
  - `term()`
  """
  @spec on_interpreter_execute_start(
          SnakeBridge.Ref.t(),
          String.t(),
          term(),
          %{optional(String.t()) => term()},
  ...
  def on_interpreter_execute_start(ref, call_id, instance, inputs, opts \\ []) do
    SnakeBridge.Runtime.call_method(
      ref,
  ...
  @doc """
  Python method `BaseCallback.on_interpreter_shutdown_end`.
  ...
  - `term()`
  """
  @spec on_interpreter_shutdown_end(
          SnakeBridge.Ref.t(),
          String.t(),
          term() | nil,
          list(term()),
  ...
  def on_interpreter_shutdown_end(ref, call_id, outputs, args, opts \\ []) do
    {args, opts} = SnakeBridge.Runtime.normalize_args_opts(args, opts)
  ...
  @doc """
  Python method `BaseCallback.on_interpreter_shutdown_start`.
  ...
  - `term()`
  """
  @spec on_interpreter_shutdown_start(
          SnakeBridge.Ref.t(),
          String.t(),
          term(),
          %{optional(String.t()) => term()},
  ...
  def on_interpreter_shutdown_start(ref, call_id, instance, inputs, opts \\ []) do
    SnakeBridge.Runtime.call_method(
      ref,
  ...
  @doc """
  Python method `BaseCallback.on_interpreter_startup_end`.
  ...
  - `term()`
  """
  @spec on_interpreter_startup_end(
          SnakeBridge.Ref.t(),
          String.t(),
          term() | nil,
          list(term()),
  ...
  def on_interpreter_startup_end(ref, call_id, outputs, args, opts \\ []) do
    {args, opts} = SnakeBridge.Runtime.normalize_args_opts(args, opts)
  ...
  @doc """
  Python method `BaseCallback.on_interpreter_startup_start`.
  ...
  - `term()`
  """
  @spec on_interpreter_startup_start(
          SnakeBridge.Ref.t(),
          String.t(),
          term(),
          %{optional(String.t()) => term()},
  ...
  def on_interpreter_startup_start(ref, call_id, instance, inputs, opts \\ []) do
    SnakeBridge.Runtime.call_method(
      ref,
  ...
  @doc """
  Python method `BaseCallback.on_interpreter_tool_call_end`.
  ...
  - `term()`
  """
  @spec on_interpreter_tool_call_end(
          SnakeBridge.Ref.t(),
          String.t(),
          term() | nil,
          list(term()),
  ...
  def on_interpreter_tool_call_end(ref, call_id, outputs, args, opts \\ []) do
    {args, opts} = SnakeBridge.Runtime.normalize_args_opts(args, opts)

    SnakeBridge.Runtime.call_method(
      ref,
      :on_interpreter_tool_call_end,
      [call_id, outputs] ++ List.wrap(args),
      opts
    )
  end
  ...
  @doc """
  Python method `BaseCallback.on_interpreter_tool_call_start`.
  ...
  - `term()`
  """
  @spec on_interpreter_tool_call_start(
          SnakeBridge.Ref.t(),
          String.t(),
          term(),
          %{optional(String.t()) => term()},
  ...
  def on_interpreter_tool_call_start(ref, call_id, instance, inputs, opts \\ []) do
    SnakeBridge.Runtime.call_method(
      ref,
  ...
  - `term()`
  """
  @spec on_module_end(SnakeBridge.Ref.t(), String.t(), term() | nil, list(term()), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
