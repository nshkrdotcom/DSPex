...
defmodule Dspy.Utils.Exceptions.AdapterParseError do
  @moduledoc """
  ...
  - `message` (term() default: None)
  - `parsed_result` (term() default: None)
  """
  @spec new(String.t(), Dspy.Signatures.SignatureClass3.t(), String.t(), list(term()), keyword()) ::
