...
defmodule Dspy.Utils do
  ...
  @spec experimental(term() | nil, String.t() | nil) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  @spec experimental(term() | nil, String.t() | nil, keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def experimental() do
  ...
  @spec pretty_print_history(list(%{optional(String.t()) => term()}), integer(), keyword()) ::
          {:ok, nil} | {:error, Snakepit.Error.t()}
  @spec pretty_print_history(list(%{optional(String.t()) => term()}), integer(), term() | nil) ::
          {:ok, nil} | {:error, Snakepit.Error.t()}
