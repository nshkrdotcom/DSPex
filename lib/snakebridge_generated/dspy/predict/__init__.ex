...
defmodule Dspy.Predict do
  ...
  All functions accept a `__runtime__` option for controlling execution behavior:
      ...
      Dspy.Predict.some_function(args, __runtime__: [timeout: 120_000])
  ...
  ### Example with timeout override
      ...
      Dspy.Predict.predict(data, __runtime__: [timeout_profile: :ml_inference])

      # Or explicit timeout
      Dspy.Predict.predict(data, __runtime__: [timeout: 600_000])

      # Route to a pool and enforce strict affinity
      Dspy.Predict.predict(data, __runtime__: [pool_name: :strict_pool, affinity: :strict_queue])
