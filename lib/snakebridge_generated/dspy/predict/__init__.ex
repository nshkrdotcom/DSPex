...
defmodule Dspy.Predict.Module do
  @moduledoc """
  ...
  All functions accept a `__runtime__` option for controlling execution behavior:
      ...
      Dspy.Predict.Module.some_function(args, __runtime__: [timeout: 120_000])
  ...
  ### Example with timeout override
      ...
      Dspy.Predict.Module.predict(data, __runtime__: [timeout_profile: :ml_inference])

      # Or explicit timeout
      Dspy.Predict.Module.predict(data, __runtime__: [timeout: 600_000])

      # Route to a pool and enforce strict affinity
      Dspy.Predict.Module.predict(data, __runtime__: [pool_name: :strict_pool, affinity: :strict_queue])
