...
defmodule Dspy.Predict.Avatar.Signatures.Actor do
  @moduledoc """
  ...
  @doc """
  Python method `Actor._get_value`.
  ...
  @doc """
  Python method `Actor._calculate_keys`.
  ...
  @doc """
  Python method `Actor.dump_state`.
  ...
  @doc """
  Python method `Actor.schema_json`.
  ...
  @doc """
  Python method `Actor.load_state`.
  ...
  @doc """
  Python method `Actor._copy_and_set_values`.
  ...
  @doc """
  Python method `Actor.update_forward_refs`.
  ...
  @doc """
  Python method `Actor.parse_file`.
