...
defmodule Dspy.Predict.Avatar.Models.Action do
  ...
  @doc """
  Python method `Action._calculate_keys`.
  ...
  @doc """
  Python method `Action._copy_and_set_values`.
  ...
  @doc """
  Python method `Action._get_value`.
  ...
  @doc """
  Python method `Action.construct`.
  ...
  @doc """
  Python method `Action.parse_file`.
  ...
  @doc """
  Python method `Action.parse_obj`.
  ...
  @doc """
  Python method `Action.parse_raw`.
  ...
  @doc """
  Python method `Action.schema_json`.
  ...
  @doc """
  Python method `Action.update_forward_refs`.
