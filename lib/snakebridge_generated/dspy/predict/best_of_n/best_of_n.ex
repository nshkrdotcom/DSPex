...
defmodule Dspy.Predict.BestOfNClass do
  @moduledoc """
  Wrapper for Python class BestOfN.
  """
  ...
  - `module` - The module to run. (type: `Module`)
  - `N` - The number of times to run the module. (type: `integer()`)
  - `reward_fn` - The reward function which takes in the args passed to the module, the resulting prediction, and returns a scalar reward. (type: `Callable[[dict, Prediction], float]`)
  - `threshold` - The threshold for the reward function. (type: `float()`)
  - `fail_count` - The number of times the module can fail before raising an error. Defaults to N if not provided. (type: `integer() | nil`)
  ...
  ## Examples
      ...
      ```
  """
  @spec new(Dspy.Primitives.ModuleClass3.t(), integer(), term(), float(), list(term()), keyword()) ::
  ...
  @doc """
  Python method `BestOfN.inspect_history`.
  ...
  @doc """
  Python method `BestOfN.named_predictors`.
  ...
  @doc """
  Python method `BestOfN.predictors`.
