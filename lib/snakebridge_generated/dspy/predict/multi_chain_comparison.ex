...
defmodule Dspy.Predict.MultiChainComparisonClass do
  @moduledoc """
  Wrapper for Python class MultiChainComparison.
  """
  ...
  @doc """
  Python method `MultiChainComparison.get_lm`.
  ...
  @doc """
  Python method `MultiChainComparison.inspect_history`.
  ...
  @doc """
  Python method `MultiChainComparison.named_predictors`.
  ...
  @doc """
  Python method `MultiChainComparison.predictors`.
  ...
  @doc """
  Python method `MultiChainComparison.set_lm`.
