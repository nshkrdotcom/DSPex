...
defmodule Dspy.Predict.ChainOfThought do
  ...
  - `rationale_field` - An optional custom `FieldInfo` for the reasoning field. If not provided, a default field with description `${reasoning}` is used.
  - `rationale_field_type` - The type annotation for the reasoning field. Defaults to `str`. Ignored if `rationale_field` is provided. **config: Additional keyword arguments forwarded to the underlying `dspy.Predict` module.

  ## Examples

      iex> import dspy
      iex> cot = dspy.ChainOfThought("question -> answer")
      iex> result = cot(question="What is the capital of France?")
      iex> print(result.reasoning)
      iex> print(result.answer)
  """
  ...
  - `rationale_field` (term() | nil default: None)
  - `rationale_field_type` (term() default: <class 'str'>)
  ...
  @doc """
  Python method `ChainOfThought._base_init`.
  ...
  @doc """
  Python method `ChainOfThought._set_lm_usage`.
  ...
  @doc """
  Python method `ChainOfThought.acall`.
  ...
  @doc """
  Python method `ChainOfThought.aforward`.
  ...
  @doc """
  Python method `ChainOfThought.dump_state`.
  ...
  @doc """
  Python method `ChainOfThought.forward`.
  ...
  @doc """
  Python method `ChainOfThought.load_state`.
  ...
  @doc """
  Python method `ChainOfThought.parameters`.
