...
defmodule Dspy.Predict.ChainOfThoughtClass do
  @moduledoc """
  Wrapper for Python class ChainOfThought.
  """
  ...
  - `signature` - The signature of the module. (type: `Type[dspy.Signature]`)
  - `rationale_field` - The field that will contain the reasoning. (type: `dspy.OutputField | pydantic.fields.FieldInfo | nil`)
  - `rationale_field_type` - The type of the rationale field. **config: The configuration for the module. (type: `Type`)
  """
  ...
  @doc """
  Python method `ChainOfThought.get_lm`.
  ...
  @doc """
  Python method `ChainOfThought.inspect_history`.
  ...
  @doc """
  Python method `ChainOfThought.named_predictors`.
  ...
  @doc """
  Python method `ChainOfThought.predictors`.
  ...
  @doc """
  Python method `ChainOfThought.set_lm`.
