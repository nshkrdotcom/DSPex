...
defmodule Dspy.Predict.Refine do
  ...
  All functions accept a `__runtime__` option for controlling execution behavior:
      ...
      Dspy.Predict.Refine.some_function(args, __runtime__: [timeout: 120_000])
  ...
  ### Example with timeout override
      ...
      Dspy.Predict.Refine.predict(data, __runtime__: [timeout_profile: :ml_inference])

      # Or explicit timeout
      Dspy.Predict.Refine.predict(data, __runtime__: [timeout: 600_000])

      # Route to a pool and enforce strict affinity
      Dspy.Predict.Refine.predict(data, __runtime__: [pool_name: :strict_pool, affinity: :strict_queue])
  ...
  @doc """
  Python binding for `dspy.predict.refine.inspect_modules`.
  ...
  @doc """
  Python binding for `dspy.predict.refine.recursive_mask`.
