...
defmodule Dspy.Primitives.PythonInterpreter do
  ...
  @doc """
  Python method `PythonInterpreter._check_session_active`.
  ...
  @doc """
  Python method `PythonInterpreter._ensure_deno_process`.
  ...
  @doc """
  Python method `PythonInterpreter._get_deno_dir`.
  ...
  @doc """
  Python method `PythonInterpreter._get_runner_path`.
  ...
  @doc """
  Python method `PythonInterpreter._mount_files`.
  ...
  @doc """
  Python method `PythonInterpreter._next_request_id`.
  ...
  @doc """
  Python method `PythonInterpreter._query_deno_dir`.
  ...
  @doc """
  Python method `PythonInterpreter._spawn_process`.
  ...
  @doc """
  Python method `PythonInterpreter._sync_files`.
  ...
  @doc """
  Python method `PythonInterpreter._write_message`.
  ...
  @doc """
  Python method `PythonInterpreter.execute`.
  ...
  @doc """
  Python method `PythonInterpreter.invoke_tool`.
  ...
  @doc """
  Python method `PythonInterpreter.shutdown`.
