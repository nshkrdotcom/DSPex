...
defmodule Dspy.Primitives.CodeInterpreter.Module do
  ...
  All functions accept a `__runtime__` option for controlling execution behavior:
      ...
      Dspy.Primitives.CodeInterpreter.Module.some_function(args, __runtime__: [timeout: 120_000])
  ...
  ### Example with timeout override
      ...
      Dspy.Primitives.CodeInterpreter.Module.predict(data, __runtime__: [timeout_profile: :ml_inference])

      # Or explicit timeout
      Dspy.Primitives.CodeInterpreter.Module.predict(data, __runtime__: [timeout: 600_000])

      # Route to a pool and enforce strict affinity
      Dspy.Primitives.CodeInterpreter.Module.predict(data, __runtime__: [pool_name: :strict_pool, affinity: :strict_queue])
