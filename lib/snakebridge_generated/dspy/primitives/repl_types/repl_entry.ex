...
# Python class: REPLEntry

defmodule Dspy.Primitives.ReplTypes.REPLEntry do
  @moduledoc """
  ...
  - `index` (integer())
  - `max_output_chars` (integer() default: 10000)
  ...
  - `String.t()`
  """
  @spec format_output(SnakeBridge.Ref.t(), String.t(), list(term()), keyword()) ::
          {:ok, String.t()} | {:error, Snakepit.Error.t()}
  def format_output(ref, output, args, opts \\ []) do
    {args, opts} = SnakeBridge.Runtime.normalize_args_opts(args, opts)
    SnakeBridge.Runtime.call_method(ref, :format_output, [output] ++ List.wrap(args), opts)
  end
