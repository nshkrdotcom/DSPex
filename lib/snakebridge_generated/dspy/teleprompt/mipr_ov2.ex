...
defmodule Dspy.Teleprompt.MIPROv2 do
  ...
  - `metric` (term())
  - `prompt_model` (term() | nil default: None)
  - `task_model` (term() | nil default: None)
  - `teacher_settings` (%{optional(term()) => term()} | nil default: None)
  - `max_bootstrapped_demos` (integer() default: 4)
  - `max_labeled_demos` (integer() default: 4)
  - `auto` (term() | nil default: 'light')
  - `num_candidates` (integer() | nil default: None)
  - `num_threads` (integer() | nil default: None)
  - `max_errors` (integer() | nil default: None)
  - `seed` (integer() default: 9)
  - `init_temperature` (float() default: 1.0)
  - `verbose` (boolean() default: False)
  - `track_stats` (boolean() default: True)
  - `log_dir` (String.t() | nil default: None)
  - `metric_threshold` (float() | nil default: None)
  """
  ...
  - `max_errors` (integer() | nil keyword-only, required)
  - `metric_threshold` (float() | nil keyword-only, required)
  ...
  @spec _bootstrap_fewshot_examples(
          ...
          term(),
          keyword()
        ) :: {:ok, list(term()) | nil} | {:error, Snakepit.Error.t()}
  ...
  - `trainset` (list(term()))
  - `valset` (list(term()) | nil)

  ## Returns

  - `term()`
  """
  @spec _set_and_validate_datasets(
          SnakeBridge.Ref.t(),
          list(term()),
          list(term()) | nil,
          keyword()
  ...
  - `program` (term())
  - `num_trials` (integer() | nil)
  - `minibatch` (boolean())
  - `zeroshot_opt` (boolean())
  - `valset` (list(term()))
  - `num_instruct_candidates` (integer() | nil)
  - `num_fewshot_candidates` (integer() | nil)
