...
defmodule Dspy.Teleprompt.Gepa.GepaUtils.ScoreWithFeedback do
  ...
  @doc """
  Python method `ScoreWithFeedback.copy`.
  ...
  @doc """
  Python method `ScoreWithFeedback.from_completions`.
  ...
  @doc """
  Python method `ScoreWithFeedback.get`.
  ...
  @doc """
  Python method `ScoreWithFeedback.get_lm_usage`.
  ...
  @doc """
  Python method `ScoreWithFeedback.inputs`.
  ...
  @doc """
  Python method `ScoreWithFeedback.items`.
  ...
  @doc """
  Python method `ScoreWithFeedback.keys`.
  ...
  @doc """
  Python method `ScoreWithFeedback.labels`.
  ...
  @doc """
  Python method `ScoreWithFeedback.set_lm_usage`.
  ...
  @doc """
  Python method `ScoreWithFeedback.toDict`.
  ...
  @doc """
  Python method `ScoreWithFeedback.values`.
  ...
  @doc """
  Python method `ScoreWithFeedback.with_inputs`.
  ...
  @doc """
  Python method `ScoreWithFeedback.without`.
