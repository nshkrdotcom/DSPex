...
defmodule Dspy.Teleprompt.Gepa.GEPA do
  ...
  - `metric` (Dspy.Teleprompt.Gepa.Gepa.GEPAFeedbackMetric.t())
  ...
  """
  @spec _build_seed_candidate(SnakeBridge.Ref.t(), Dspy.Primitives.ModuleClass3.t(), keyword()) ::
  ...
  - `student` (Dspy.Primitives.ModuleClass3.t())
  - `trainset` (list(Dspy.Primitives.ExampleClass.t()) keyword-only, required)
