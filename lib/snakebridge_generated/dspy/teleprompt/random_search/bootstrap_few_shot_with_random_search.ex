...
# Python class: BootstrapFewShotWithRandomSearch

defmodule Dspy.Teleprompt.RandomSearch.BootstrapFewShotWithRandomSearch do
  @moduledoc """
  Wrapper for Python class BootstrapFewShotWithRandomSearch.
  """
