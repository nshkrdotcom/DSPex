...
# Python class: SignatureOptimizer

defmodule Dspy.Teleprompt.SignatureOpt.SignatureOptimizer do
  @moduledoc """
  Wrapper for Python class SignatureOptimizer.
  """
  ...
  @doc """
  Python method `SignatureOptimizer._check_candidates_equal`.
  ...
  @doc """
  Python method `SignatureOptimizer._drop_duplicates`.
  ...
  @doc """
  Python method `SignatureOptimizer._get_signature`.
  ...
  @doc """
  Python method `SignatureOptimizer._print_signature`.
  ...
  @doc """
  Python method `SignatureOptimizer._set_signature`.
  ...
  - `student` (term())
  - `devset` (term() keyword-only, required)
