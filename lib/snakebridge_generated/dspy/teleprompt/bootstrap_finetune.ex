...
defmodule Dspy.Teleprompt.BootstrapFinetune do
  ...
  - `train_kwargs` ((%{optional(String.t()) => term()} | %{optional(term()) => %{optional(String.t()) => term()}})
  | nil default: None)
  - `adapter` ((term() | %{optional(term()) => term()}) | nil default: None)
  ...
  - `lm` (term())
  - `pred_ind` (integer() | nil default: None)
