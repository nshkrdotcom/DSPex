...
# Library: dspy 3.4.0
# Python module: dspy.retrievers
# Python class: EmbeddingsWithScores

defmodule Dspy.Retrievers.EmbeddingsWithScores do
  @moduledoc """
  ...
  def __snakebridge_python_class__, do: "EmbeddingsWithScores"
  ...
  @doc """
  Python method `EmbeddingsWithScores._batch_forward`.
  ...
  @doc """
  Python method `EmbeddingsWithScores._build_faiss`.
  ...
  @doc """
  Python method `EmbeddingsWithScores._faiss_search`.
  ...
  @doc """
  Python method `EmbeddingsWithScores._normalize`.
  ...
  @doc """
  Python method `EmbeddingsWithScores._rerank_and_predict`.

  ## Parameters

  - `q_embeds` (term())
  - `candidate_indices` (term() | nil)

  ## Returns

  - `term()`
  """
  @spec _rerank_and_predict(SnakeBridge.Ref.t(), term(), term() | nil, keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
