...
defmodule Dspy.Experimental.Score do
  @moduledoc """
  ...
  def __snakebridge_python_class__, do: "Score"
  ...
  @doc """
  Python method `Score.schema_json`.
  ...
  @doc """
  Python method `Score.parse_file`.
  ...
  @doc """
  Python method `Score._calculate_keys`.
  ...
  @doc """
  Python method `Score.update_forward_refs`.
  ...
  @doc """
  Python method `Score._copy_and_set_values`.
  ...
  @doc """
  Python method `Score._get_value`.
  ...
  @doc """
  Python method `Score.serialize_model`.
