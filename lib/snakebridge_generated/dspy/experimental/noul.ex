...
defmodule Dspy.Experimental.Noul do
  @moduledoc """
  ...
  def __snakebridge_python_class__, do: "Noul"
  ...
  @doc """
  Python method `Noul.schema_json`.
  ...
  @doc """
  Python method `Noul._calculate_keys`.
  ...
  @doc """
  Python method `Noul.update_forward_refs`.
  ...
  @doc """
  Python method `Noul._copy_and_set_values`.
  ...
  @doc """
  Python method `Noul.serialize_model`.
