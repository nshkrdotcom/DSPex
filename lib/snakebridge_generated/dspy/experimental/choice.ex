...
defmodule Dspy.Experimental.Choice do
  @moduledoc """
  ...
  def __snakebridge_python_class__, do: "Choice"
  ...
  @doc """
  Python method `Choice.schema_json`.
  ...
  @doc """
  Python method `Choice.parse_file`.
  ...
  @doc """
  Python method `Choice._calculate_keys`.
  ...
  @doc """
  Python method `Choice.construct`.
  ...
  @doc """
  Python method `Choice.update_forward_refs`.
  ...
  @doc """
  Python method `Choice._copy_and_set_values`.
  ...
  @spec format(SnakeBridge.Ref.t(), keyword()) ::
          {:ok, list(%{optional(String.t()) => term()}) | String.t()}
  ...
  - `term()`
  """
  @spec criteria(SnakeBridge.Ref.t(), keyword()) :: {:ok, term()} | {:error, Snakepit.Error.t()}
  def criteria(ref, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :criteria, [], opts)
  end
  ...
  @doc """
  Python method `Choice._get_value`.
  ...
  @doc """
  Python method `Choice.parse_obj`.
  ...
  @doc """
  Python method `Choice.parse_raw`.
  ...
  @doc """
  Python method `Choice.serialize_model`.
  ...
  - `term()`
  """
  @spec serialize_model(SnakeBridge.Ref.t(), term(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def serialize_model(ref, handler, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :serialize_model, [handler], opts)
  end
  ...
  @spec _criteria_json(SnakeBridge.Ref.t()) :: {:ok, term()} | {:error, Snakepit.Error.t()}
  def _criteria_json(ref) do
    SnakeBridge.Runtime.get_attr(ref, :_criteria_json)
  end
