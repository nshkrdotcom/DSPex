...
# Python class: Citations

defmodule Dspy.Experimental.Citations do
  @moduledoc """
  ...
  @doc """
  Python method `Citations.schema_json`.
  ...
  - `type` (String.t() keyword-only default: 'char_location')
  - `cited_text` (String.t() keyword-only, required)
  - `document_index` (integer() keyword-only, required)
  - `document_title` (String.t() | nil keyword-only default: None)
  - `start_char_index` (integer() keyword-only, required)
  - `end_char_index` (integer() keyword-only, required)
  - `supported_text` (String.t() | nil keyword-only default: None)
  ...
  @doc """
  Python method `Citations.parse_file`.
  ...
  @doc """
  Python method `Citations.schema`.
  ...
  - `boolean()`
  """
  @spec adapt_to_native_lm_feature(SnakeBridge.Ref.t(), term(), term(), term(), term(), keyword()) ::
  ...
  - `citations_dicts` - A list of dictionaries, where each dictionary should have 'cited_text' key and 'document_index', 'start_char_index', 'end_char_index' keys.
  ...
  @doc """
  Python method `Citations._calculate_keys`.
  ...
  @doc """
  Python method `Citations.construct`.
  ...
  @doc """
  Python method `Citations.update_forward_refs`.
  ...
  @doc """
  Python method `Citations._copy_and_set_values`.
  ...
  @doc """
  Python method `Citations._get_value`.
  ...
  @doc """
  Python method `Citations.validate_input`.
  ...
  @doc """
  Python method `Citations.parse_obj`.
  ...
  @doc """
  Python method `Citations.from_orm`.
  ...
  @doc """
  Python method `Citations.parse_raw`.
  ...
  @doc """
  Python method `Citations.validate`.
  ...
  @doc """
  Python method `Citations.serialize_model`.
