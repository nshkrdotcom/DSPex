...
defmodule Dspy.Evaluate.AutoEvaluation do
  ...
  All functions accept a `__runtime__` option for controlling execution behavior:
      ...
      Dspy.Evaluate.AutoEvaluation.some_function(args, __runtime__: [timeout: 120_000])
  ...
  ### Example with timeout override
      ...
      Dspy.Evaluate.AutoEvaluation.predict(data, __runtime__: [timeout_profile: :ml_inference])

      # Or explicit timeout
      Dspy.Evaluate.AutoEvaluation.predict(data, __runtime__: [timeout: 600_000])

      # Route to a pool and enforce strict affinity
      Dspy.Evaluate.AutoEvaluation.predict(data, __runtime__: [pool_name: :strict_pool, affinity: :strict_queue])
  ...
  @doc """
  Python binding for `dspy.evaluate.auto_evaluation.f1_score`.
