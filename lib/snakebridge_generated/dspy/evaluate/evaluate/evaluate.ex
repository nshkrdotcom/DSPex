...
defmodule Dspy.Evaluate.Evaluate.Evaluate do
  @moduledoc """
  DSPy Evaluate class.
  ...
  - `devset` (list(Dspy.Primitives.Example.t()) keyword-only, required)
  ...
  - `results` (list({Dspy.Primitives.Example.t(), Dspy.Primitives.Example.t(), term()}))
