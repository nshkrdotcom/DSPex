...
defmodule Dspy.EvaluateClass do
  ...
  - `display_table` (boolean() | integer() keyword-only default: False)
  - `max_errors` (integer() | nil keyword-only default: None)
  - `provide_traceback` (boolean() | nil keyword-only default: None)
  - `failure_score` (float() keyword-only default: 0.0)
  - `save_as_csv` (String.t() | nil keyword-only default: None)
  - `save_as_json` (String.t() | nil keyword-only default: None)
  - `kwargs` (term())
  """
