...
# Library: dspy 3.4.0
# Python module: dspy
# Python class: ProgramOfThought

defmodule Dspy.ProgramOfThought do
  @moduledoc """
  .. deprecated:: 3.4
  ...
  - `max_iters` (integer() default: 3)
  - `interpreter_factory` (term() default: <class 'dspy.primitives.python_interpreter.PythonInterpreter'>)
  """
  ...
  @doc """
  Python method `ProgramOfThought._base_init`.
  ...
  - `term()`
  """
  @spec _execute_code(SnakeBridge.Ref.t(), String.t(), term(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def _execute_code(ref, code, interpreter, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_execute_code, [code, interpreter], opts)
  end

  @doc """
  Python method `ProgramOfThought._generate_instruction`.
  ...
  @doc """
  Python method `ProgramOfThought._generate_signature`.
  ...
  - `interpreter` (term() | nil)

  ## Returns

  - `term()`
  """
  @spec _interpreter_context(SnakeBridge.Ref.t(), term() | nil, keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def _interpreter_context(ref, interpreter, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_interpreter_context, [interpreter], opts)
  end

  @doc """
  Python method `ProgramOfThought._parse_code`.
  ...
  @doc """
  Python method `ProgramOfThought._set_lm_usage`.
  ...
  @doc """
  Python method `ProgramOfThought.acall`.
  ...
  @doc """
  Python method `ProgramOfThought.dump_state`.
  ...
  - `interpreter` - Optional caller-owned interpreter, passed positionally. The caller must shut it down. **kwargs: Input values matching the signature's input fields.
  ...
  @doc """
  Python method `ProgramOfThought.load_state`.
  ...
  @doc """
  Python method `ProgramOfThought.parameters`.
