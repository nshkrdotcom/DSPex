...
defmodule Dspy.Datasets.DataLoader do
  ...
  - `file_path` (String.t())
  - `fields` (list(String.t()) | nil default: None)
  ...
  - `fields` ({String.t()} | nil keyword-only default: None)
  - `kwargs` (term())
  ...
  @spec from_huggingface(SnakeBridge.Ref.t(), String.t(), list(term()), keyword()) ::
          {:ok, term() | list(term())} | {:error, Snakepit.Error.t()}
  ...
  - `train_seeds` (list(integer()) | nil default: None)
  ...
  - `train_seed` (integer() | nil default: None)
  - `train_size` (integer() | nil default: None)
  - `eval_seed` (integer() | nil default: None)
  - `dev_size` (integer() | nil default: None)
  - `test_size` (integer() | nil default: None)
  ...
  - `list(term())`
  """
  @spec sample(SnakeBridge.Ref.t(), list(term()), integer(), list(term()), keyword()) ::
          {:ok, list(term())} | {:error, Snakepit.Error.t()}
  ...
  - `dataset` (list(term()))
  - `train_size` (integer() | float() default: 0.75)
  - `test_size` ((integer() | float()) | nil default: None)
  - `random_state` (integer() | nil default: None)

  ## Returns

  - `term()`
  """
  @spec train_test_split(SnakeBridge.Ref.t(), list(term()), list(term()), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
