...
defmodule Dspy.Predict do
  ...
  - `term()`
  """
  @spec get_criteria(SnakeBridge.Ref.t(), term(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def get_criteria(ref, field, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :get_criteria, [field], opts)
  end
  ...
  - `allow_unsafe_lm_state` - If True, preserves `api_base`, `base_url`, and `model_list` from serialized LM state and allows importing custom LM classes. Enable only when loading trusted files.
  ...
  - `term()`
  """
  @spec set_criteria(SnakeBridge.Ref.t(), term(), term(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def set_criteria(ref, field, criteria, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :set_criteria, [field, criteria], opts)
  end
