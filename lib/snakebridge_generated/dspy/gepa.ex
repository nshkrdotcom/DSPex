...
defmodule Dspy.GEPA do
  ...
  - `code_proposer` - Optional custom proposer for `dspy.Flex` code components, implementing the `CodeProposalFn` protocol from `dspy.teleprompt.gepa.gepa_utils`. **Default: None** - Uses the built-in code proposer, which rewrites each Flex submodule's full `module_src` from the failing examples and feedback.
  ...
  - `max_full_evals` (integer() | nil keyword-only default: None)
  - `max_metric_calls` (integer() | nil keyword-only default: None)
  - `reflection_minibatch_size` (integer() keyword-only default: 3)
  - `candidate_selection_strategy` (term() keyword-only default: 'pareto')
  - `reflection_lm` (term() | nil keyword-only default: None)
  - `skip_perfect_score` (boolean() keyword-only default: True)
  - `add_format_failure_as_feedback` (boolean() keyword-only default: False)
  - `instruction_proposer` (term() | nil keyword-only default: None)
  - `code_proposer` (term() | nil keyword-only default: None)
  - `component_selector` (term() | String.t() keyword-only default: 'round_robin')
  - `use_merge` (boolean() keyword-only default: True)
  - `max_merge_invocations` (integer() | nil keyword-only default: 5)
  - `num_threads` (integer() | nil keyword-only default: None)
  - `failure_score` (float() keyword-only default: 0.0)
  - `perfect_score` (float() keyword-only default: 1.0)
  - `log_dir` (String.t() | nil keyword-only default: None)
  - `track_stats` (boolean() keyword-only default: False)
  - `use_wandb` (boolean() keyword-only default: False)
  - `wandb_api_key` (String.t() | nil keyword-only default: None)
  - `wandb_init_kwargs` (%{optional(String.t()) => term()} | nil keyword-only default: None)
  ...
  - `seed` (integer() | nil keyword-only default: 0)
  - `gepa_kwargs` (%{optional(term()) => term()} | nil keyword-only default: None)
  """
  ...
  - `teacher` (term() | nil keyword-only default: None)
  - `valset` (list(term()) | nil keyword-only default: None)
