...
defmodule Dspy.Adapters.TwoStepAdapterClass do
  @moduledoc """
  ...
  - `extraction_model` (Dspy.Clients.LMClass.t())
  - `kwargs` (term())
  """
  ...
  - `signature` (Dspy.Signatures.Signature.Signature.t())
  ...
  - `%{optional(String.t()) => term()}`
  """
  @spec parse(SnakeBridge.Ref.t(), Dspy.Signatures.Signature.Signature.t(), String.t(), keyword()) ::
