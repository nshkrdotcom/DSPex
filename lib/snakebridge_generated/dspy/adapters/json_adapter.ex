...
defmodule Dspy.Adapters.JSONAdapter do
  ...
  @doc """
  Python method `JSONAdapter._make_json_adapter_fallback`.
  ...
  - `term()`
  """
  @spec _prepare_response_format(SnakeBridge.Ref.t(), term(), term(), term(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def _prepare_response_format(ref, lm, lm_kwargs, signature, opts \\ []) do
    SnakeBridge.Runtime.call_method(
      ref,
      :_prepare_response_format,
      [lm, lm_kwargs, signature],
      opts
    )
  end
