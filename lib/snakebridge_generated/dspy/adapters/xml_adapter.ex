...
defmodule Dspy.Adapters.XMLAdapter do
  ...
  - `native_response_types` (list(term()) | nil default: None)
  - `use_json_adapter_fallback` (boolean() default: True)
  - `parallel_tool_calls` (boolean() | nil default: None)
  """
  ...
  @doc """
  Python method `XMLAdapter._call_postprocess`.

  ## Parameters

  - `processed_signature` (term())
  - `original_signature` (term())
  - `outputs` (list(%{optional(String.t()) => term()} | String.t()))
  - `lm` (term())
  ...
  @spec _call_postprocess(
          ...
          term(),
          term(),
          list(%{optional(String.t()) => term()} | String.t()),
          term(),
  ...
  @doc """
  Python method `XMLAdapter._call_preprocess`.
  ...
  @doc """
  Python method `XMLAdapter._elements_to_value`.

  ## Parameters

  - `elements` (list(term()))
  - `schema` (%{optional(term()) => term()})
  - `definitions` (%{optional(term()) => term()})

  ## Returns

  - `term()`
  """
  @spec _elements_to_value(
          SnakeBridge.Ref.t(),
          list(term()),
          %{optional(term()) => term()},
          %{optional(term()) => term()},
  ...
  def _elements_to_value(ref, elements, schema, definitions, opts \\ []) do
    SnakeBridge.Runtime.call_method(
      ref,
      :_elements_to_value,
      [elements, schema, definitions],
      opts
    )
  end

  @doc """
  Python method `XMLAdapter._get_history_field_name`.
  ...
  @doc """
  Python method `XMLAdapter._get_tool_call_input_field_name`.
  ...
  @doc """
  Python method `XMLAdapter._get_tool_call_output_field_name`.
  ...
  @doc """
  Python method `XMLAdapter._group_children`.
  ...
  """
  @spec _group_children(SnakeBridge.Ref.t(), term(), keyword()) ::
          {:ok, %{optional(String.t()) => list(term())}} | {:error, Snakepit.Error.t()}
  def _group_children(ref, element, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_group_children, [element], opts)
  end

  @doc """
  Python method `XMLAdapter._make_json_adapter_fallback`.

  ## Returns

  - `term()`
  """
  @spec _make_json_adapter_fallback(SnakeBridge.Ref.t(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def _make_json_adapter_fallback(ref, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_make_json_adapter_fallback, [], opts)
  end

  @doc """
  Python method `XMLAdapter._schema_to_xml`.
  ...
  def _schema_to_xml(ref, tag, schema, definitions, seen, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_schema_to_xml, [tag, schema, definitions, seen], opts)
  end

  @doc """
  Python method `XMLAdapter._uses_nested_xml`.
  ...
  - `boolean()`
  """
  @spec _uses_nested_xml(SnakeBridge.Ref.t(), term(), keyword()) ::
          {:ok, boolean()} | {:error, Snakepit.Error.t()}
  def _uses_nested_xml(ref, annotation, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_uses_nested_xml, [annotation], opts)
  end

  @doc """
  Python method `XMLAdapter._value_to_xml`.
  ...
  - `String.t()`
  """
  @spec _value_to_xml(SnakeBridge.Ref.t(), term(), String.t(), list(term()), keyword()) ::
          {:ok, String.t()} | {:error, Snakepit.Error.t()}
  def _value_to_xml(ref, value, tag, args, opts \\ []) do
    {args, opts} = SnakeBridge.Runtime.normalize_args_opts(args, opts)
    SnakeBridge.Runtime.call_method(ref, :_value_to_xml, [value, tag] ++ List.wrap(args), opts)
  end

  @doc """
  Python method `XMLAdapter._xml_schema`.
  ...
  - `String.t()`
  """
  @spec _xml_schema(SnakeBridge.Ref.t(), String.t(), term(), keyword()) ::
          {:ok, String.t()} | {:error, Snakepit.Error.t()}
  def _xml_schema(ref, tag, annotation, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :_xml_schema, [tag, annotation], opts)
  end

  @doc """
  Python method `XMLAdapter.acall`.
  ...
  - `String.t()`
  """
  @spec format_field_with_value(SnakeBridge.Ref.t(), %{optional(term()) => term()}, keyword()) ::
          {:ok, String.t()} | {:error, Snakepit.Error.t()}
