...
# Python class: ToolCallResults

defmodule Dspy.Adapters.Types.ToolCallResults do
  @moduledoc """
  Wrapper for Python class ToolCallResults.
  """
  def __snakebridge_python_name__, do: "dspy.adapters.types"
  def __snakebridge_python_class__, do: "ToolCallResults"
  ...
  @doc """
  Python method `ToolCallResults._calculate_keys`.
  ...
  @doc """
  Python method `ToolCallResults._copy_and_set_values`.
  ...
  @doc """
  Python method `ToolCallResults._get_value`.
  ...
  @doc """
  Python method `ToolCallResults._iter`.
  ...
  @doc """
  Python method `ToolCallResults.construct`.
  ...
  @doc """
  Python method `ToolCallResults.dict`.
  ...
  @doc """
  Python method `ToolCallResults.from_orm`.
  ...
  @doc """
  Python method `ToolCallResults.from_tool_calls_and_values`.

  ## Parameters

  - `tool_calls` (list(term()) | term())
  - `values` (list(term()))
  - `is_errors` (list(boolean()) | nil default: None)

  ## Returns

  - `term()`
  """
  @spec from_tool_calls_and_values(
          SnakeBridge.Ref.t(),
          list(term()) | term(),
          list(term()),
          list(term()),
  ...
  def from_tool_calls_and_values(ref, tool_calls, values, args, opts \\ []) do
    {args, opts} = SnakeBridge.Runtime.normalize_args_opts(args, opts)

    SnakeBridge.Runtime.call_method(
      ref,
      :from_tool_calls_and_values,
      [tool_calls, values] ++ List.wrap(args),
      opts
    )
  end

  @doc """
  Python method `ToolCallResults.json`.
  ...
  @doc """
  Python method `ToolCallResults.parse_file`.
  ...
  @doc """
  Python method `ToolCallResults.parse_obj`.
  ...
  @doc """
  Python method `ToolCallResults.parse_raw`.
  ...
  @doc """
  Python method `ToolCallResults.schema`.
  ...
  @doc """
  Python method `ToolCallResults.schema_json`.
  ...
  @doc """
  Python method `ToolCallResults.ToolCallResult`.

  ## Parameters

  - `call_id` (String.t() | nil keyword-only default: None)
  - `name` (String.t() keyword-only, required)
  - `value` (term() keyword-only, required)
  ...
  - `nil`
  """
  @spec tool_call_result(SnakeBridge.Ref.t(), keyword()) ::
          {:ok, nil} | {:error, Snakepit.Error.t()}
  def tool_call_result(ref, opts \\ []) do
    kw_keys = opts |> Keyword.keys() |> Enum.map(&to_string/1)
    missing_kw = ["name", "value"] |> Enum.reject(&(&1 in kw_keys))
    ...
    SnakeBridge.Runtime.call_method(ref, "ToolCallResult", [], opts)
  end

  @doc """
  Python method `ToolCallResults.update_forward_refs`.
  ...
  @doc """
  Python method `ToolCallResults.validate`.
  ...
  @doc """
  Python method `ToolCallResults.validate_input`.
