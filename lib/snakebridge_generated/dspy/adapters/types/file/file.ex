...
defmodule Dspy.Adapters.Types.FileClass do
  @moduledoc """
  ...
  - `file_id` (String.t())
  - `filename` (term() default: None)

  ## Returns

  - `Dspy.Adapters.Types.FileClass.t()`
  """
  @spec from_file_id(SnakeBridge.Ref.t(), String.t(), list(term()), keyword()) ::
          {:ok, Dspy.Adapters.Types.FileClass.t()} | {:error, Snakepit.Error.t()}
