...
defmodule Dspy.Adapters.Types.Image do
  ...
  - `download: Whether remote URLs should be downloaded to infer their MIME type.` - 
  - `verify: Whether to verify SSL certificates when downloading images from URLs. Set to False for self-signed certificates. Default is True.` - 
