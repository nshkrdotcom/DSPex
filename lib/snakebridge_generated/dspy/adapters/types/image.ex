...
defmodule Dspy.Adapters.Types.Image do
  ...
  def new(source, download, verify, opts \\ []) do
    SnakeBridge.Runtime.call_class(__MODULE__, :__init__, [source, download, verify], opts)
  end

  @doc """
  Python method `Image.schema_json`.
  ...
  @doc """
  Python method `Image.parse_file`.
  ...
  - `term()`
  """
  @spec from_path(SnakeBridge.Ref.t(), String.t(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  def from_path(ref, file_path, opts \\ []) do
    SnakeBridge.Runtime.call_method(ref, :from_path, [file_path], opts)
  end
  ...
  @doc """
  Python method `Image._calculate_keys`.
  ...
  @doc """
  Python method `Image.update_forward_refs`.
  ...
  @doc """
  Python method `Image._copy_and_set_values`.
  ...
  @doc """
  Python method `Image._get_value`.
  ...
  - `timeout` (float() | nil default: 30.0)
  ...
  @doc """
  Python method `Image.serialize_model`.
