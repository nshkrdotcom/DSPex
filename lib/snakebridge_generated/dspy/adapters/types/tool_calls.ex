...
# Python class: ToolCalls

defmodule Dspy.Adapters.Types.ToolCalls do
  @moduledoc """
  ...
  @doc """
  Python method `ToolCalls.schema_json`.
  ...
  @doc """
  Python method `ToolCalls.parse_file`.
  ...
  @doc """
  Python method `ToolCalls.schema`.
  ...
  @doc """
  Python method `ToolCalls._calculate_keys`.
  ...
  @doc """
  Python method `ToolCalls.construct`.
  ...
  - `id` (String.t() | nil keyword-only default: None)
  - `name` (String.t() keyword-only, required)
  - `args` (%{optional(String.t()) => term()} keyword-only, required)
  ...
  @doc """
  Python method `ToolCalls.update_forward_refs`.
  ...
  @doc """
  Python method `ToolCalls._copy_and_set_values`.
  ...
  @doc """
  Python method `ToolCalls.format`.
  ...
  @doc """
  Python method `ToolCalls._get_value`.
  ...
  @doc """
  Python method `ToolCalls.validate_input`.
  ...
  @doc """
  Python method `ToolCalls.parse_obj`.
  ...
  @doc """
  Python method `ToolCalls.from_orm`.
  ...
  @doc """
  Python method `ToolCalls.parse_raw`.
  ...
  @doc """
  Python method `ToolCalls.validate`.
  ...
  @doc """
  Python method `ToolCalls.serialize_model`.
