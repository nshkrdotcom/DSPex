...
defmodule Dspy.Adapters.Types.Citation.Citations do
  @moduledoc """
  ...
  - `Dspy.Adapters.Types.Citation.Citations.t() | nil`
  """
  ...
  - `document_title` (term() keyword-only default: None)
  - `start_char_index` (integer() keyword-only, required)
  - `end_char_index` (integer() keyword-only, required)
  - `supported_text` (term() keyword-only default: None)
  ...
  - `Dspy.Adapters.Types.Citation.Citations.t()`
  """
