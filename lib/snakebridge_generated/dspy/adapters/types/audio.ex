...
defmodule Dspy.Adapters.Types.Audio do
  ...
  @doc """
  Python method `Audio.schema_json`.
  ...
  @doc """
  Python method `Audio.parse_file`.
  ...
  @doc """
  Python method `Audio._calculate_keys`.
  ...
  @doc """
  Python method `Audio.update_forward_refs`.
  ...
  @doc """
  Python method `Audio._copy_and_set_values`.
  ...
  @doc """
  Python method `Audio._get_value`.
  ...
  - `timeout` - Seconds to wait for the server before raising `requests.exceptions.Timeout`. `None` disables the timeout and can hang indefinitely on an unresponsive host.
  ...
  @doc """
  Python method `Audio.serialize_model`.
