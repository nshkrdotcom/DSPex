...
defmodule Dspy.Adapters.Types.Tool do
  ...
  - `func` - The actual function that is being wrapped by the tool. (type: `Callable`)
  - `name` - The name of the tool. Defaults to None. (type: `String.t() | nil`)
  - `desc` - The description of the tool. Defaults to None. (type: `String.t() | nil`)
  - `args` - The args and their schema of the tool, represented as a dictionary from arg name to arg's json schema. Defaults to None. (type: `map() | nil`)
  - `arg_types` - The argument types of the tool, represented as a dictionary from arg name to the type of the argument. Defaults to None. (type: `map() | nil`)
  - `arg_desc` - Descriptions for each arg, represented as a dictionary from arg name to description string. Defaults to None. (type: `map() | nil`)
  """
  ...
  @doc """
  Python method `Tool.schema_json`.
  ...
  @doc """
  Python method `Tool._validate_and_parse_args`.
  ...
  - `result_mode` - `"text"` preserves DSPy's existing text/non-text conversion. `"structured"` returns MCP structured content exactly when present, with the existing conversion as fallback.
  ...
  @doc """
  Python method `Tool._calculate_keys`.
  ...
  @doc """
  Python method `Tool.format_as_litellm_function_call`.
  ...
  @doc """
  Python method `Tool.construct`.

  ## Parameters

  - `fields_set` (MapSet.t(String.t()) | nil default: None)
  - `values` (term())
  ...
  @doc """
  Python method `Tool._run_async_in_sync`.
  ...
  - `term() | nil`
  """
  @spec parse_lm_response(
          SnakeBridge.Ref.t(),
          String.t() | %{optional(String.t()) => term()},
          keyword()
        ) :: {:ok, term() | nil} | {:error, Snakepit.Error.t()}
  ...
  @doc """
  Python method `Tool.update_forward_refs`.
  ...
  @doc """
  Python method `Tool._copy_and_set_values`.
  ...
  - `term()`
  """
  @spec model_validate_json(SnakeBridge.Ref.t(), (String.t() | binary()) | binary(), keyword()) ::
          {:ok, term()} | {:error, Snakepit.Error.t()}
  ...
  - `func` (term())
  - `arg_desc` (%{optional(String.t()) => String.t()} | nil default: None)
  ...
  @doc """
  Python method `Tool.serialize_model`.
