defmodule DSPex.Testing.MockIsolation do
  ...
  ## Usage in Tests
      ...
      use DSPex.Testing.MockIsolation
  ...
  def current_mock_name do
    Process.get(:test_mock_name, DSPex.Adapters.Mock)
  end
  ...
  defmacro __using__(_opts) do
    quote do
      import DSPex.Testing.MockIsolation
      setup :setup_isolated_mock

      # Override Mock module in this context to use isolated instance
      alias DSPex.Testing.MockIsolation.IsolatedMock, as: Mock
    end
  end
end

defmodule DSPex.Testing.MockIsolation.IsolatedMock do
  @moduledoc false
  # Wrapper module that delegates to the test-specific Mock instance

  alias DSPex.Testing.MockIsolation
  ...
  def get_test_capabilities do
    DSPex.Adapters.Mock.get_test_capabilities()
  end

  def supports_test_layer?(layer) do
    DSPex.Adapters.Mock.supports_test_layer?(layer)
  end
