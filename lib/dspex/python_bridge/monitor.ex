defmodule DSPex.PythonBridge.Monitor do
  ...
  ## Usage
      ...
      # Start the monitor
      {:ok, _pid} = DSPex.PythonBridge.Monitor.start_link()

      # Get health status
      status = DSPex.PythonBridge.Monitor.get_health_status()

      # Force a health check
      :ok = DSPex.PythonBridge.Monitor.force_health_check()
  """
  ...
  defstruct config: @default_config,
            bridge_name: DSPex.PythonBridge.Bridge,
  ...
  ## Examples
      ...
      {:ok, pid} = DSPex.PythonBridge.Monitor.start_link()
      {:ok, pid} = DSPex.PythonBridge.Monitor.start_link(name: MyMonitor)
  """
  ...
  ## Examples
      ...
      :ok = DSPex.PythonBridge.Monitor.reset_stats()
  """
  @spec reset_stats() :: :ok
  def reset_stats do
  ...
  ## Examples
      ...
      :ok = DSPex.PythonBridge.Monitor.stop()
  """
  @spec stop() :: :ok
  def stop do
  ...
  ## Examples
      ...
      :ok = DSPex.PythonBridge.Monitor.stop(:my_monitor)
  """
  ...
  defp build_config(opts) do
    app_config = Application.get_env(:dspex, :python_bridge_monitor, %{})
