defmodule DSPex.Signature.JsonSchema do
  ...
  ## Examples
      ...
      ...> }
      iex> schema = DSPex.Signature.JsonSchema.generate(signature, :openai)
      iex> schema.type
      "object"
  ...
  ## Examples
      ...
      iex> DSPex.Signature.JsonSchema.type_to_json_schema(:string, [])
      %{type: "string"}

      iex> DSPex.Signature.JsonSchema.type_to_json_schema({:list, :string}, [])
      %{type: "array", items: %{type: "string"}}

      iex> DSPex.Signature.JsonSchema.type_to_json_schema(:probability, [])
