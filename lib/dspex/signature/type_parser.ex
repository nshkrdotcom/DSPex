defmodule DSPex.Signature.TypeParser do
  ...
  ## Examples
      ...
      iex> DSPex.Signature.TypeParser.parse_type(:string)
      {:ok, :string}

      iex> DSPex.Signature.TypeParser.parse_type({:list, :string})
      {:ok, {:list, :string}}

      iex> DSPex.Signature.TypeParser.parse_type({:dict, :string, :integer})
      {:ok, {:dict, :string, :integer}}

      iex> DSPex.Signature.TypeParser.parse_type(:invalid)
  ...
  ## Examples
      ...
      iex> DSPex.Signature.TypeParser.is_valid_type?(:string)
      true

      iex> DSPex.Signature.TypeParser.is_valid_type?({:list, :string})
      true

      iex> DSPex.Signature.TypeParser.is_valid_type?(:invalid)
      false
  """
  ...
  ## Examples
      ...
      iex> DSPex.Signature.TypeParser.basic_types()
  ...
  ## Examples
      ...
      iex> DSPex.Signature.TypeParser.ml_types()
  ...
  ## Examples
      ...
      iex> length(DSPex.Signature.TypeParser.all_types())
      11
  """
  @spec all_types() :: [atom()]
  ...
  ## Examples
      ...
      iex> DSPex.Signature.TypeParser.describe_type(:string)
      "string"

      iex> DSPex.Signature.TypeParser.describe_type({:list, :string})
      "list of string"

      iex> DSPex.Signature.TypeParser.describe_type({:dict, :string, :integer})
  ...
  ## Examples
      ...
      iex> DSPex.Signature.TypeParser.validate_type_definition(:string)
      :ok

      iex> DSPex.Signature.TypeParser.validate_type_definition({:list, :invalid})
  ...
  ## Examples
      ...
      iex> DSPex.Signature.TypeParser.extract_referenced_types(:string)
      [:string]

      iex> DSPex.Signature.TypeParser.extract_referenced_types({:list, :string})
      [:string]

      iex> DSPex.Signature.TypeParser.extract_referenced_types({:union, [:string, :integer]})
      [:string, :integer]
  """
