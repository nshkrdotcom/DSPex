defmodule AshDSPex.PythonBridge.EnvironmentCheckTest do
  use ExUnit.Case, async: true

  # Layer 2: Protocol testing - checks Python environment but doesn't need bridge
  @moduletag :layer_2

  alias AshDSPex.PythonBridge.EnvironmentCheck
  ...
  describe "check_dspy_availability/0" do
    test "handles missing python gracefully" do
      ...
      try do
        Application.put_env(:ash_dspex, :python_bridge, %{python_executable: "nonexistent_python"})
  ...
  describe "validate_environment/0" do
    ...
    test "handles configuration overrides" do
      ...
      try do
        ...
        Application.put_env(:ash_dspex, :python_bridge, custom_config)
  ...
  describe "version comparison" do
    test "version parsing and comparison works correctly" do
      ...
      try do
        ...
        Application.put_env(:ash_dspex, :python_bridge, high_version_config)
  ...
  describe "package validation" do
    test "handles package import name conversion" do
      ...
      try do
        ...
        Application.put_env(:ash_dspex, :python_bridge, config_with_dspy)
