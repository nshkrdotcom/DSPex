defmodule AshDSPex.ErrorHandlingTest do
  @moduledoc """
  ...
  alias AshDSPex.{Config, Testing.TestMode}
  alias AshDSPex.PythonBridge.Protocol

  describe "configuration error handling" do
    @invalid_configs [
      {"ASH_DSPEX_BRIDGE_TIMEOUT", "not_a_number", :default_timeout, :python_bridge},
      {"ASH_DSPEX_HEALTH_CHECK_INTERVAL", "bad", :health_check_interval, :python_bridge_monitor},
      {"ASH_DSPEX_FAILURE_THRESHOLD", "xyz", :failure_threshold, :python_bridge_monitor}
    ]
  ...
  describe "concurrent error handling" do
    test "handles multiple simultaneous errors gracefully" do
      # Save original value
      original = System.get_env("ASH_DSPEX_BRIDGE_TIMEOUT")
      ...
      System.put_env("ASH_DSPEX_BRIDGE_TIMEOUT", "concurrent_invalid")
      ...
      # Cleanup
      if original do
        System.put_env("ASH_DSPEX_BRIDGE_TIMEOUT", original)
      else
        System.delete_env("ASH_DSPEX_BRIDGE_TIMEOUT")
      end
    end
  end
  ...
  describe "error recovery" do
    test "system recovers after invalid configuration is fixed" do
      ...
      log1 =
        capture_log(fn ->
          System.put_env("ASH_DSPEX_BRIDGE_TIMEOUT", "invalid")
      ...
      log2 =
        capture_log(fn ->
          System.put_env("ASH_DSPEX_BRIDGE_TIMEOUT", "5000")
