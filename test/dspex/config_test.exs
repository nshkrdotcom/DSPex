defmodule DSPex.ConfigTest do
  ...
  describe "validate/0" do
    ...
    test "detects invalid configuration" do
      ...
      try do
        ...
        Application.put_env(:dspex, :python_bridge, invalid_config)
  ...
  describe "environment variable overrides" do
    setup do
      ...
      original_vars = %{
        "DSPEX_PYTHON_EXECUTABLE" => System.get_env("DSPEX_PYTHON_EXECUTABLE"),
        "DSPEX_BRIDGE_TIMEOUT" => System.get_env("DSPEX_BRIDGE_TIMEOUT"),
        "DSPEX_HEALTH_CHECK_INTERVAL" => System.get_env("DSPEX_HEALTH_CHECK_INTERVAL")
      }
    ...
    test "applies python executable override" do
      System.put_env("DSPEX_PYTHON_EXECUTABLE", "python3.9")
    ...
    test "applies timeout override" do
      System.put_env("DSPEX_BRIDGE_TIMEOUT", "45000")
    ...
    test "applies health check interval override" do
      System.put_env("DSPEX_HEALTH_CHECK_INTERVAL", "15000")
    ...
    test "handles multiple invalid values with appropriate warnings" do
      log =
        capture_log(fn ->
          ...
          System.put_env("DSPEX_HEALTH_CHECK_INTERVAL", "bad_value")
          System.put_env("DSPEX_FAILURE_THRESHOLD", "xyz")
    ...
    test "handles negative numbers appropriately" do
      ...
      log =
        capture_log(fn ->
          System.put_env("DSPEX_BRIDGE_TIMEOUT", "-1000")
