defmodule DSPex.Adapters.RegistryTest do
  use ExUnit.Case, async: false

  alias DSPex.Adapters.{Registry, Mock, BridgeMock, PythonPort}
  ...
  setup do
    ...
    original_config = Application.get_env(:dspex, :adapter)
    ...
    on_exit(fn ->
      ...
      if original_config do
        Application.put_env(:dspex, :adapter, original_config)
      else
        Application.delete_env(:dspex, :adapter)
      end
    end)
  ...
  describe "get_adapter/1" do
    ...
    test "respects application configuration" do
      ...
      DSPex.Testing.TestMode.clear_test_mode_override()
      ...
      assert Application.get_env(:dspex, :adapter) == :mock
    end
  ...
  describe "non-test environment behavior" do
    test "ignores TEST_MODE outside of test environment" do
      ...
      try do
        ...
        System.put_env("TEST_MODE", "mock_adapter")
        Application.put_env(:dspex, :adapter, :python_port)
