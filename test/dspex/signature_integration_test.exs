defmodule DSPex.SignatureIntegrationTest do
  ...
  describe "dynamic signature system integration" do
    ...
    test "executes a program with multi-output dynamic signature", %{adapter: adapter} do
      ...
      inputs = %{
        text: "I love coding in Elixir. It is a joy to work with such an elegant language."
      }
      ...
      case adapter.execute_program(prog_id, inputs) do
        ...
        {:error, reason} ->
          ...
          {:ok, fallback_result} =
            adapter.execute_program(prog_id, %{
              question: "What is the sentiment of: 'I love Elixir'?"
            })
      ...
      {:ok, prog_id} =
        adapter.create_program(%{
          ...
          signature: %{
            ...
            # Empty name should trigger fallback
            inputs: [%{name: "", type: "invalid"}],
