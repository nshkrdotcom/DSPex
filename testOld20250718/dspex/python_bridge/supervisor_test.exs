defmodule DSPex.PythonBridge.SupervisorTest do
  @moduledoc """
  ...
  use DSPex.UnifiedTestFoundation, :supervision_testing

  # Only run in full_integration mode
  @moduletag :layer_3

  alias DSPex.PythonBridge.Supervisor, as: BridgeSupervisor
  import DSPex.UnifiedTestFoundation, only: [wait_for_supervision_tree_ready: 2]
