defmodule DSPex.GeminiIntegrationTest do
  ...
  import DSPex.BridgeTestHelpers, only: [wait_for_bridge_startup: 2]
    ...
    setup do
      case System.get_env("GEMINI_API_KEY") do
        ...
        _key ->
          ...
          case wait_for_bridge_startup(DSPex.PythonBridge.Bridge, 10_000) do
            {:ok, :ready} -> :ok
